...
Данные можно найти во вкладке "Базы данных" в игровой панели управления, подробнее о вкладке можно узнать тут: [Базы данных](/ru/panel/databases#просмотр-информации-о-базе-данных)
