...
Максимальное количество чеков, которые игрок может написать.
...
Эта настройка используется В ДОПОЛНЕНИЕ к `GM.Config.weaponCheckerHideDefault` и `GM.Config.weaponCheckerHideNoLicense`.
...
Вы можете создавать свои профессии с любыми параметрами. Например, создадим профессию "Мэр":
