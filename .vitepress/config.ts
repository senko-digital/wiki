              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    { text: 'Backups', link: '/panel/backups' },
                    { text: 'Schedules', link: '/panel/schedules' },
                    { text: 'Users', link: '/panel/users' },
                    { text: 'Startup Parameters', link: '/panel/startup' },
              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    { text: 'Бэкапы', link: '/ru/panel/backups' },
                    { text: 'Расписания', link: '/ru/panel/schedules' },
                    { text: 'Пользователи', link: '/ru/panel/users' },
                    { text: 'Параметры запуска', link: '/ru/panel/startup.md' },
                    { text: 'Настройки', link: '/ru/panel/settings' },
